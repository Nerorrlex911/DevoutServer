...
object ClassUtil {
     ...
     * @return
     */
    fun getAnnotationMember(clazz: Class<*>, annotation: Class<out Annotation>): Set<Field> {
     ...
     * @return
     */
    fun getAnnotationMethod(clazz: Class<*>, annotation: Class<out Annotation>): Set<Method> {
