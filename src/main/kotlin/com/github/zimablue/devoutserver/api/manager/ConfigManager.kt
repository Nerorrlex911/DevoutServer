...
import com.github.zimablue.devoutserver.api.decouple.map.BaseMap
...
//        subPouvoir.decouple.completeYaml(file, ignores)
    @Deprecated("Deprecated", ReplaceWith(""))
    fun completeYaml(filePath: String, ignores: Set<String> = emptySet()): Map<String, Any?> =emptyMap()
//        subPouvoir.decouple.completeYaml(filePath, ignores)
}
